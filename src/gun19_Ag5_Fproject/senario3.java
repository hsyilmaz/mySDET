...
public class senario3 extends BaseStaticDriver {
    public static void main(String[] args) {
        ...
        WebElement State_option = driver.findElement(By.cssSelector("[id='BillingNewAddress_StateProvinceId']>option"));
        wait.until(ExpectedConditions.stalenessOf(State_option));
